...
namespace MyProject.Sample.Tests.External
{
    ...
    public partial class RestClient 
    {
        ...
        /// <param name="x_Correlation_ID">Correlation id to match request between services. This is also known as External id</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.List<WeatherForecast>> WeatherForecastAsync(string? x_Correlation_ID = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.List<WeatherForecast>>(response_, headers_).ConfigureAwait(false);
